...
// 刪除帳號 (呼叫最新的 delete-user Edge Function)
...
.tabs button { padding: 10px 20px; border: none; background: none; font-size: 16px; font-weight: bold; color: #7f8c8d; cursor: pointer; border-radius: 6px; transition: 0.2s; }
.tabs button.active { background: #3498db; color: white; }
.tabs button:hover:not(.active) { background: #ecf0f1; }

.admin-card { background: white; padding: 25px; border-radius: 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); margin-bottom: 25px; }
.admin-card h3 { margin-top: 0; color: #34495e; border-bottom: 1px solid #eee; padding-bottom: 10px; margin-bottom: 15px; }
.desc { color: #7f8c8d; font-size: 14px; margin-bottom: 15px; }
...
.empty-state { text-align: center; color: #95a5a6; padding: 20px !important; }
...
.pairing-select { width: 100%; padding: 8px; border: 1px solid #bdc3c7; border-radius: 4px; }

.btn { padding: 10px 20px; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; transition: 0.2s; }
.small-btn { padding: 6px 12px; font-size: 13px; }
.primary-btn { background: #3498db; color: white; }
.success-btn { background: #2ecc71; color: white; display: inline-block; }
